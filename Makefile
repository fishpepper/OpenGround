CFLAGS  = -O1 -g
ASFLAGS = -g
GENERIC_SRCS  = main.c delay.c assert.c led.c lcd.c screen.c console.c font.c debug.c io.c adc.c sound.c timeout.c touch.c cc2500.c spi.c frsky.c storage.c wdt.c
